...
assert(source["index.html"].includes("app.js?v=20260915a"), "app.jsのキャッシュ更新番号が古いままです");
assert(source["index.html"].includes("period-integrity.js?v=20260915b"), "period-integrity.jsのキャッシュ更新番号が古いままです");
assert(source["index.html"].includes("health-integrity.js?v=20260915a"), "health-integrity.jsのキャッシュ更新番号が古いままです");
